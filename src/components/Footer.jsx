    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6">
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-10">
        ...
        <div>
          <div className="flex items-center gap-2.5 mb-5">
            ...
            />
            <div className="items-center gap-2.5 hidden">
          ...
          <div className="text-slate-500 text-sm space-y-1.5">
            <a href="tel:+13604241325" className="flex items-center gap-2 hover:text-slate-200 transition-colors">
              <svg className="w-3.5 h-3.5 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
              </svg>
              (360) 424-1325
            </a>
            <div className="text-slate-600 text-xs pl-5">Toll Free: (800) 285-4598</div>
            <div className="text-slate-600 text-xs pl-5">Fax: (360) 424-5212</div>
            <a href="mailto:mike@meyersign.com" className="flex items-center gap-2 hover:text-slate-200 transition-colors">
              <svg className="w-3.5 h-3.5 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-start gap-2">
              ...
              <span>2608 Old Highway 99 South<br/>Mount Vernon, WA 98273</span>
            </div>
          </div>
      ...
      <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-3">
        <p className="text-slate-600 text-xs">
          © {new Date().getFullYear()} Meyer Sign & Advertising Co., Inc. All rights reserved.
        </p>
        <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6">
          <p className="text-slate-700 text-xs">
            Mount Vernon, WA · Est. 1960 · Licensed, Bonded & Insured
          </p>
          <a href="https://pixelarchitecture.dev" target="_blank" rel="noopener noreferrer"
            className="text-slate-800 hover:text-slate-600 text-xs transition-colors">
            Built by <span className="text-slate-600 font-semibold">Pixel Architecture</span>
          </a>
        </div>
      </div>
    </div>
